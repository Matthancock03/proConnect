...
// @DATE:Mon May 04 09:52:29 PDT 2015
...
// @LINE:26
private[this] lazy val controllers_MessageController_message15 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("message"))))
        

// @LINE:28
private[this] lazy val controllers_SearchController_loadSearchedProfile16 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("loadSearchedProfile"))))
        

// @LINE:29
private[this] lazy val controllers_SearchController_search17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search"))))
        

// @LINE:33
private[this] lazy val controllers_Android_androidLogin18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidLogin"))))
        

// @LINE:34
private[this] lazy val controllers_Android_androidCreateAccount19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidCreateAccount"))))
        

// @LINE:35
private[this] lazy val controllers_Android_androidSaveUser20 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidSaveUser"))))
...
// @LINE:40
private[this] lazy val controllers_WebJarAssets_at22 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("webjars/"),DynamicPart("file", """.+""",false))))
        

// @LINE:43
private[this] lazy val securesocial_controllers_LoginPage_login23 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:44
private[this] lazy val securesocial_controllers_LoginPage_logout24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("logout"))))
        

// @LINE:47
private[this] lazy val securesocial_controllers_Registration_startSignUp25 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:48
private[this] lazy val securesocial_controllers_Registration_handleStartSignUp26 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:49
private[this] lazy val securesocial_controllers_Registration_signUp27 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:50
private[this] lazy val securesocial_controllers_Registration_handleSignUp28 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:51
private[this] lazy val securesocial_controllers_Registration_startResetPassword29 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:52
private[this] lazy val securesocial_controllers_Registration_handleStartResetPassword30 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:53
private[this] lazy val securesocial_controllers_Registration_resetPassword31 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:54
private[this] lazy val securesocial_controllers_Registration_handleResetPassword32 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:55
private[this] lazy val securesocial_controllers_PasswordChange_page33 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:56
private[this] lazy val securesocial_controllers_PasswordChange_handlePasswordChange34 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:60
private[this] lazy val securesocial_controllers_ProviderController_authenticate35 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:61
private[this] lazy val securesocial_controllers_ProviderController_authenticateByPost36 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:62
private[this] lazy val securesocial_controllers_ProviderController_notAuthorized37 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("not-authorized"))))
...
// @LINE:26
case controllers_MessageController_message15(params) => {
   call { 
...
// @LINE:28
case controllers_SearchController_loadSearchedProfile16(params) => {
   call(params.fromQuery[String]("email", None)) { (email) =>
...
// @LINE:29
case controllers_SearchController_search17(params) => {
   call { 
...
// @LINE:33
case controllers_Android_androidLogin18(params) => {
...
// @LINE:34
case controllers_Android_androidCreateAccount19(params) => {
   call(params.fromQuery[String]("email", None), params.fromQuery[String]("password", None)) { (email, password) =>
...
// @LINE:35
case controllers_Android_androidSaveUser20(params) => {
   call { 
...
// @LINE:40
case controllers_WebJarAssets_at22(params) => {
...
// @LINE:43
case securesocial_controllers_LoginPage_login23(params) => {
   call { 
...
// @LINE:44
case securesocial_controllers_LoginPage_logout24(params) => {
   call { 
...
// @LINE:47
case securesocial_controllers_Registration_startSignUp25(params) => {
   call { 
...
// @LINE:48
case securesocial_controllers_Registration_handleStartSignUp26(params) => {
   call { 
...
// @LINE:49
case securesocial_controllers_Registration_signUp27(params) => {
...
// @LINE:50
case securesocial_controllers_Registration_handleSignUp28(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:51
case securesocial_controllers_Registration_startResetPassword29(params) => {
   call { 
...
// @LINE:52
case securesocial_controllers_Registration_handleStartResetPassword30(params) => {
   call { 
...
// @LINE:53
case securesocial_controllers_Registration_resetPassword31(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:54
case securesocial_controllers_Registration_handleResetPassword32(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:55
case securesocial_controllers_PasswordChange_page33(params) => {
   call { 
...
// @LINE:56
case securesocial_controllers_PasswordChange_handlePasswordChange34(params) => {
   call { 
...
// @LINE:60
case securesocial_controllers_ProviderController_authenticate35(params) => {
...
// @LINE:61
case securesocial_controllers_ProviderController_authenticateByPost36(params) => {
   call(params.fromPath[String]("provider", None)) { (provider) =>
...
// @LINE:62
case securesocial_controllers_ProviderController_notAuthorized37(params) => {
   call { 
