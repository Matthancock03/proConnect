...
// @LINE:17
private[this] lazy val controllers_SearchController_search10 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search"))))
...
// @LINE:17
case controllers_SearchController_search10(params) => {
   call { 
