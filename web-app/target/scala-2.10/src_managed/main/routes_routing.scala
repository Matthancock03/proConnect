...
// @LINE:29
private[this] lazy val controllers_UserController_removeConnection17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("removeConnection"))))
        

// @LINE:32
private[this] lazy val controllers_MessageController_message18 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("message"))))
        

// @LINE:33
private[this] lazy val controllers_MessageController_sentMessages19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("getSentMessages"))))
        

// @LINE:34
private[this] lazy val controllers_MessageController_deleteMessage20 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("deleteMessage"))))
        

// @LINE:37
private[this] lazy val controllers_SearchController_loadSearchedProfile21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("loadSearchedProfile"))))
        

// @LINE:38
private[this] lazy val controllers_SearchController_search22 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("search"))))
        

// @LINE:39
private[this] lazy val controllers_SearchController_loadProfile23 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("loadProfile"))))
        

// @LINE:40
private[this] lazy val controllers_SearchController_searchBySkill24 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("searchBySkill"))))
        

// @LINE:41
private[this] lazy val controllers_SearchController_searchByProfession25 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("searchByProfession"))))
        

// @LINE:46
private[this] lazy val controllers_Android_androidLogin26 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidLogin"))))
        

// @LINE:47
private[this] lazy val controllers_Android_androidCreateAccount27 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidCreateAccount"))))
        

// @LINE:48
private[this] lazy val controllers_Android_androidSaveUser28 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidSaveUser"))))
        

// @LINE:49
private[this] lazy val controllers_Android_androidSearchUser29 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidSearchUser"))))
        

// @LINE:50
private[this] lazy val controllers_Android_androidGetMessages30 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidGetMessages"))))
        

// @LINE:51
private[this] lazy val controllers_Android_androidGetConnections31 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidGetConnections"))))
        

// @LINE:52
private[this] lazy val controllers_Android_androidAddConnection32 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("androidAddConnection"))))
...
// @LINE:57
private[this] lazy val controllers_WebJarAssets_at34 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("webjars/"),DynamicPart("file", """.+""",false))))
        

// @LINE:60
private[this] lazy val securesocial_controllers_LoginPage_login35 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:61
private[this] lazy val securesocial_controllers_LoginPage_logout36 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("logout"))))
        

// @LINE:64
private[this] lazy val securesocial_controllers_Registration_startSignUp37 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:65
private[this] lazy val securesocial_controllers_Registration_handleStartSignUp38 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:66
private[this] lazy val securesocial_controllers_Registration_signUp39 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:67
private[this] lazy val securesocial_controllers_Registration_handleSignUp40 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:68
private[this] lazy val securesocial_controllers_Registration_startResetPassword41 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:69
private[this] lazy val securesocial_controllers_Registration_handleStartResetPassword42 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:70
private[this] lazy val securesocial_controllers_Registration_resetPassword43 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:71
private[this] lazy val securesocial_controllers_Registration_handleResetPassword44 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:72
private[this] lazy val securesocial_controllers_PasswordChange_page45 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:73
private[this] lazy val securesocial_controllers_PasswordChange_handlePasswordChange46 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:77
private[this] lazy val securesocial_controllers_ProviderController_authenticate47 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:78
private[this] lazy val securesocial_controllers_ProviderController_authenticateByPost48 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:79
private[this] lazy val securesocial_controllers_ProviderController_notAuthorized49 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("not-authorized"))))
...
// @LINE:29
case controllers_UserController_removeConnection17(params) => {
   call(params.fromQuery[String]("email", None)) { (email) =>
...
// @LINE:32
case controllers_MessageController_message18(params) => {
   call { 
...
// @LINE:33
case controllers_MessageController_sentMessages19(params) => {
   call { 
...
// @LINE:34
case controllers_MessageController_deleteMessage20(params) => {
   call(params.fromQuery[Long]("id", None)) { (id) =>
...
// @LINE:37
case controllers_SearchController_loadSearchedProfile21(params) => {
   call(params.fromQuery[String]("email", None)) { (email) =>
...
// @LINE:38
case controllers_SearchController_search22(params) => {
   call { 
...
// @LINE:39
case controllers_SearchController_loadProfile23(params) => {
   call(params.fromQuery[Long]("id", None)) { (id) =>
...
// @LINE:40
case controllers_SearchController_searchBySkill24(params) => {
...
// @LINE:41
case controllers_SearchController_searchByProfession25(params) => {
   call(params.fromQuery[String]("queryName", None)) { (queryName) =>
...
// @LINE:46
case controllers_Android_androidLogin26(params) => {
...
// @LINE:47
case controllers_Android_androidCreateAccount27(params) => {
   call(params.fromQuery[String]("email", None), params.fromQuery[String]("password", None)) { (email, password) =>
...
// @LINE:48
case controllers_Android_androidSaveUser28(params) => {
   call { 
...
// @LINE:49
case controllers_Android_androidSearchUser29(params) => {
...
// @LINE:50
case controllers_Android_androidGetMessages30(params) => {
   call(params.fromQuery[Long]("id", None)) { (id) =>
...
// @LINE:51
case controllers_Android_androidGetConnections31(params) => {
   call(params.fromQuery[String]("email", None)) { (email) =>
...
// @LINE:52
case controllers_Android_androidAddConnection32(params) => {
...
// @LINE:57
case controllers_WebJarAssets_at34(params) => {
...
// @LINE:60
case securesocial_controllers_LoginPage_login35(params) => {
   call { 
...
// @LINE:61
case securesocial_controllers_LoginPage_logout36(params) => {
   call { 
...
// @LINE:64
case securesocial_controllers_Registration_startSignUp37(params) => {
   call { 
...
// @LINE:65
case securesocial_controllers_Registration_handleStartSignUp38(params) => {
   call { 
...
// @LINE:66
case securesocial_controllers_Registration_signUp39(params) => {
...
// @LINE:67
case securesocial_controllers_Registration_handleSignUp40(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:68
case securesocial_controllers_Registration_startResetPassword41(params) => {
   call { 
...
// @LINE:69
case securesocial_controllers_Registration_handleStartResetPassword42(params) => {
   call { 
...
// @LINE:70
case securesocial_controllers_Registration_resetPassword43(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:71
case securesocial_controllers_Registration_handleResetPassword44(params) => {
   call(params.fromPath[String]("token", None)) { (token) =>
...
// @LINE:72
case securesocial_controllers_PasswordChange_page45(params) => {
   call { 
...
// @LINE:73
case securesocial_controllers_PasswordChange_handlePasswordChange46(params) => {
   call { 
...
// @LINE:77
case securesocial_controllers_ProviderController_authenticate47(params) => {
...
// @LINE:78
case securesocial_controllers_ProviderController_authenticateByPost48(params) => {
   call(params.fromPath[String]("provider", None)) { (provider) =>
...
// @LINE:79
case securesocial_controllers_ProviderController_notAuthorized49(params) => {
   call { 
