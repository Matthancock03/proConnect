...
// @LINE:8
private[this] lazy val controllers_DbController_loginPage2 = Route("GET", PathPattern(List(StaticPart(Routes.prefix))))
...
// @LINE:8
case controllers_DbController_loginPage2(params) => {
   call { 
