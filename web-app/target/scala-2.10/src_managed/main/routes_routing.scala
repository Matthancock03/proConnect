// @SOURCE:/Users/LB/Desktop/proConnect/web-app/conf/routes
...
// @LINE:14
private[this] lazy val controllers_Application_about8 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("about"))))
...
// @LINE:21
private[this] lazy val securesocial_controllers_LoginPage_login11 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:22
private[this] lazy val securesocial_controllers_LoginPage_logout12 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("logout"))))
        

// @LINE:25
private[this] lazy val securesocial_controllers_Registration_startSignUp13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:26
private[this] lazy val securesocial_controllers_Registration_handleStartSignUp14 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup"))))
        

// @LINE:27
private[this] lazy val securesocial_controllers_Registration_signUp15 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:28
private[this] lazy val securesocial_controllers_Registration_handleSignUp16 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("signup/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:29
private[this] lazy val securesocial_controllers_Registration_startResetPassword17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:30
private[this] lazy val securesocial_controllers_Registration_handleStartResetPassword18 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset"))))
        

// @LINE:31
private[this] lazy val securesocial_controllers_Registration_resetPassword19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:32
private[this] lazy val securesocial_controllers_Registration_handleResetPassword20 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("reset/"),DynamicPart("token", """[^/]+""",true))))
        

// @LINE:33
private[this] lazy val securesocial_controllers_PasswordChange_page21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:34
private[this] lazy val securesocial_controllers_PasswordChange_handlePasswordChange22 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("password"))))
        

// @LINE:38
private[this] lazy val securesocial_controllers_ProviderController_authenticate23 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:39
private[this] lazy val securesocial_controllers_ProviderController_authenticateByPost24 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("authenticate/"),DynamicPart("provider", """[^/]+""",true))))
        

// @LINE:40
private[this] lazy val securesocial_controllers_ProviderController_notAuthorized25 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("not-authorized"))))
...
// @LINE:14
case controllers_Application_about8(params) => {
   call { 
...
// @LINE:40
case securesocial_controllers_ProviderController_notAuthorized25(params) => {
   call { 
